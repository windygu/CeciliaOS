...
namespace Aura_OS.System.Shell.cmdIntr.FileSystem
{
    class Edit : ICommand
    {
        public Edit(string[] commandvalues) : base(commandvalues)
        {
        ...
        public ReturnInfo Execute(string edit, short startIndex = 0, short count = 5)
        {
            ...
            else
            {
                ...
                return new ReturnInfo(this, ReturnCode.CRASH);
            }
        }
