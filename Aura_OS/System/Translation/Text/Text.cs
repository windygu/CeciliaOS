            ...
            switch (Kernel.langSelected)
            {
                ...
                case "en_US":
                    ...
                    switch (ToTranslate)
                    {
                        ...
                        case "about":
                            Console.ForegroundColor = ConsoleColor.White;
                            Console.WriteLine("Cecilia [version " + Kernel.version + "-" + Kernel.revision + "]");
                            Console.WriteLine("Created by Biscuitcube Studio and Ziegler Yuan.");
                            Console.WriteLine();
                            Console.ForegroundColor = ConsoleColor.Green;
                            Console.WriteLine("Email: customer@biscuitcube.top");
                            Console.ForegroundColor = ConsoleColor.White;
                            break;
                        case "errorthisisafile":
